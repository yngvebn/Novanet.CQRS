...
$strPath = ".\lib\net40\*.dll"
Write-Host $strPath
$Assembly = [Reflection.Assembly]::Loadfile(@(gci $strPath)[0].FullName)
...
$AssemblyTitle = Get-AssemblyCustomProperty -Assembly $Assembly -TypeNameLike "Title" -Property "Title"
$AssemblyDescription =Get-AssemblyCustomProperty -Assembly $Assembly -TypeNameLike "Description" -Property "Description"
$AssemblyCompany = Get-AssemblyCustomProperty -Assembly $Assembly -TypeNameLike "Company" -Property "Company"
$AssemblyProduct = Get-AssemblyCustomProperty -Assembly $Assembly -TypeNameLike "Product" -Property "Product"
$AssemblyCopyright = Get-AssemblyCustomProperty -Assembly $Assembly -TypeNameLike "Copyright" -Property "Copyright"

Write-Host $AssemblyTitle
...
$file.package.metadata.title = "$AssemblyTitle"
$file.package.metadata.id = "$AssemblyProduct"
$file.package.metadata.summary = "$AssemblyDescription"
$file.package.metadata.description = "$AssemblyDescription"
$file.package.metadata.copyright = "$AssemblyCopyright"
$file.package.metadata.authors = "$AssemblyCompany"
$file.package.metadata.projectUrl = "https://nuget.org/packages/$AssemblyProduct"
$file.Save($path)
